...
class ModeloEmpresa {
    ...
    public function inserirBD(Empresa $empresa) {
        ...
        echo $modeloCategoria->retornaIdBD($empresa->getCategoria());
...
//            $p_sql->bindValue(':fkcategoria', $modeloCategoria->retornaIdBD($empresa->getCategoria()));
...
//            $p_sql->bindValue(':telefone2', $empresa->getTelefone2());
